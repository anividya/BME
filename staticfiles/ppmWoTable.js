...
function saveState() {
    ...
    localStorage.setItem('ppmwotableState', JSON.stringify(state));
}

function loadState() {
    const savedState = localStorage.getItem('ppmwotableState');
    if (savedState) {
...
function renderTable(data) {
    const tableBody = document.getElementById('ppmwotableBody');
    tableBody.innerHTML = '';
    data.forEach(row => {
