        ...
        tr.innerHTML = `
            ...
            <td>
                ...
                UserGroup === "MANAGEMENT"
                    ? `<a href="#pr_ModalAdmin" onclick="prModal('${row.PR_No}','${row.Asset_Name}','${row.Need}','${row.Features}','${row.Requested_Date}','${row.Department}','${row.Status}')" class="edit-btn btn btn-warning btn-sm" data-toggle="modal">
                            <i class="fas fa-info"></i>Action</a>`

                : UserGroup === "BMEADMIN"
                    ? `<a href="#pr_ModalBME" onclick="prModal('${row.PR_No}','${row.Asset_Name}','${row.Need}','${row.Features}','${row.Requested_Date}','${row.Department}','${row.Status}')" class="edit-btn btn btn-warning btn-sm" data-toggle="modal">
                                <i class="fas fa-info"></i>Action</a>`: ''
            } 
            </td>
        `;
        tableBody.appendChild(tr); //onclick="woid('${row.PR_No}')"
    });
}
